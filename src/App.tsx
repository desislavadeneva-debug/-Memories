  ...
  },
{
 ...
 },
 {
   name: "Бойко Денев",
   role: "Frontend Developer",
   message: "Радвам се, че те срещнах. Научих много не само в професионален план, но и в житейски. Благодаря ти, че не ми отне шанса да се реализирам, както и за всеки друг в екипа ни. В три думи - благороден, запомнящ се, колоритен! Желая ти пътят ти да бъде стръмен, но проходим!",
  id: 13
 }
