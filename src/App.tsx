...
},
{
  ...
  message:"В Дубай разбрах, че дори зад най-сериозното лице се крие човек с чувство за хумор.Е, поне така си мисля — още не съм сигурен. :smile: Ерудиран, стриктен и винаги stoneface — дори в пустинята на 45 градуса.Успех, Олег! Ще ни липсваш – и този път няма как да го скриеш с stoneface."
}
];
