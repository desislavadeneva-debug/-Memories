...
const wishes: Wish[] = [
  
  {
    ...
    id: 1,
    role: "Maintenance",
    message: "Успех в квото се захванеш, по-читаво планиране и по-малко лавиране измежду всевъзможни и невъзможни обстоятелства, повече пари и по-малко работа 😄",
  },
  {
  id:2,
  name: "Сашо Иванов",
 ...
 role: "Senior Frontend Developer",
  message: "След теб остава вдъхновение, след нас – дълбока благодарност. Пожелавам ти смелост да следваш мечтите си, късмет във всяко ново начало и безкрайно вдъхновение по пътя напред!"
},
{
  id:5,
  name: "Любомир Илиев",
  role: "Frontend Developer",
  message:"Искам отново да ти благодаря за шанса, който ми даде и за приятната обстановка, в която започнах да работя и да се уча на много нови неща. На всички ще ни липсва хумора ти и цялостното ти присъствие при нас в офиса. Пожелавам ти да имаш много успехи на новото място и да продължаваш да се развиваш."
},
{
  id: 6,
  name: "Антонио Донов",
  role:"Head of Business Development",
  message:"В Дубай разбрах, че дори зад най-сериозното лице се крие човек с чувство за хумор. Е, поне така си мисля — още не съм сигурен. 😄 Ерудиран, стриктен и винаги stoneface  🗿 — дори в пустинята на 45 градуса. Успех, Олег! Ще ни липсваш – и този път няма как да го скриеш с stoneface 🗿."
},
{
  id:7,
  name: "Десислава Денева",
  role: "Frontend Developer",
  message:"Ти не беше просто лидер, а човекът, който ми даде начало и посока. Благодаря ти, че ме изгради и повярва в мен, когато още не бях готова да повярвам сама. Благодарение на теб днес вървя уверено по пътя си и знам, че мога повече, отколкото вярвах тогава. Остави следа, която ще нося със себе си винаги."
}
];
